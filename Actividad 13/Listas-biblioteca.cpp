...
int main() {
	...
	do {
		...
		case 4: cout << "Buscando..." << endl;
			...
			break;
		case 5: cout << "Busacando..." << endl;
			if (buscarLibrosEnEspanol())
				cout << "Hay libros en espanol" << endl;
			else 
				cout << "No se ha encontrado ningun libro en espanol" << endl;
			break;
		case 6: cout << "Busacando..." << endl;
			if (buscarLibrosDCienciaF())
				cout << "Hay libros de ciencia ficcion" << endl;
			else
				cout << "No se ha encontrado ningun libro de ciencia ficcion" << endl;
			break;
